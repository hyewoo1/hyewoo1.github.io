var store = [{
        ...
        "excerpt":"Docker container backup and restore 1. Check the current container ID $ docker ps -a CONTAINER ID IMAGE COMMAND CREATED STATUS PORTS NAMES 10ecb9562a8c myoracle19c:latest \"/bin/sh -c 'exec $O…\" 2 minutes ago Exited (143) About a minute ago myoracle19c 2. Save the container as a Docker image docker commit 10ecb9562a8c...","categories": ["Docker"],
        "tags": ["Docker"],
        "url": "/docker/Docker-container-backup-and-restore/",
        "teaser": null
      },{
        "title": "Using Oracle 19c Docker Image on Windows",
        "excerpt":"Using Oracle 19c Docker Image on Windows This guide will help you use the Oracle 19c Docker image on Windows. To run Docker containers on Windows, you need to use Docker Desktop. All steps are explained to work within the Windows environment without using Linux commands. 1. Install Docker Desktop...","categories": ["Database"],
        "tags": ["OracleDB","Docker","Oracle19c","Database"],
        "url": "/database/Using-Oracle-19c-Docker-Image-on-Windows/",
        "teaser": null
      },{
        "title": "How to use git",
        "excerpt":"How to Use Git Git Reference Git - Official Documentation What is a Git Repository? A Git repository is a storage location for your project’s files and version history. Git GUI [GitKraken Legendary Git Tools GitKraken](https://www.gitkraken.com/) Basic Git Commands Check Git Version git -v Check the Status of the Git...","categories": ["Git"],
        "tags": ["Git"],
        "url": "/git/How-to-use-git/",
        "teaser": null
      }]
